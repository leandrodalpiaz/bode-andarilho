...
- API Starlette `/api/v1` com autenticação Supabase, convites, eventos, rotação segura de link público, cards, presenças, auditoria e endpoint público.
...
- `python -m pytest -q` — 39 testes aprovados nesta revisão.
